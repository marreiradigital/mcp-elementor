...
= 0.1.1 =
* Corrige set_page_settings para sincronizar o template do WordPress (_wp_page_template) quando a chave template e informada, fazendo o layout Elementor Canvas (sem header/footer) valer de fato.
